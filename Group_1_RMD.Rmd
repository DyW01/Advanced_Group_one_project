...
```{r Install and load packages - Alternative 1, include= FALSE}
...
here()
setwd("C:/Users/Icebe/OneDrive/Skrivebord/R statistics course/Tasks and other files/Advanced_Group_one_project") #Have to change the content between "C:/...." accoridngly to ones own computer 
nontidy_data <- read_delim("Data/exam_nontidy.txt", delim = "\t")
tidy_data <- nontidy_data
join_data <- read_delim("Data/exam_joindata.txt", delim = "\t")
